...
void Parameter_t::config_from_ros_handle(const ros::NodeHandle &nh)
{
	...
	read_essential_param(nh, "gain/KdAngR", gain.KdAngR);
	read_essential_param(nh, "gain/KdAngP", gain.KdAngP);
	read_essential_param(nh, "gain/KdAngY", gain.KdAngY);

	read_essential_param(nh, "max_angular_vel/omega_x", maxAngularVel.omega_x);
	read_essential_param(nh, "max_angular_vel/omega_y", maxAngularVel.omega_y);
	read_essential_param(nh, "max_angular_vel/omega_z", maxAngularVel.omega_z);
	...
	read_essential_param(nh, "take_off", take_off);
	read_essential_param(nh, "T_ss", T_ss);
	read_essential_param(nh, "J_ss", J_ss);
