...
int main(int argc, char *argv[])
{
  ...
  ROS_INFO("Initial value for hov_thr set to %.2f/%.2f", fsm.hov_thr_kf.get_hov_thr(),
  ...
  //   std::string topic_name = odom_sub.getTopic();
  //   ROS_INFO("odom_sub Subscribed to topic: %s", topic_name.c_str());
