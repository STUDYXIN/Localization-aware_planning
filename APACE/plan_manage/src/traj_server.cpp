...
namespace fast_planner
{
  ...
  void TrajServer::init(ros::NodeHandle &nh)
  {
    ...
    nh.param("traj_server/keyboard_vector", keyboard_vector, 0);
    ...
    start_eval_service_ = nh.advertiseService("/services/start_eval", &TrajServer::startEvalCallback, this);
    ...
    airsim_sync_sub_.reset(new message_filters::Subscriber<nav_msgs::Odometry>(nh, "/airsim_node/drone_1/odom_local_enu", 25));
    vins_sync_sub_.reset(new message_filters::Subscriber<nav_msgs::Odometry>(nh, "/vins_estimator/odometry", 25));
