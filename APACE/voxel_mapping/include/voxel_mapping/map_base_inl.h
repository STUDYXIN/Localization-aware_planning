...
namespace voxel_mapping
{
  ...
  void MapBase<VoxelType>::initMapData()
  {
    map_data_->data.resize(map_config_.map_size_idx_.prod());
  }

  template <typename VoxelType>
  void MapBase<VoxelType>::initRaycaster()
  {
  ...
  template <typename VoxelType>
  VoxelIndex MapBase<VoxelType>::positionToIndex(const Position &pos)
  {
    VoxelIndex idx;
  ...
  template <typename VoxelType>
  Position MapBase<VoxelType>::indexToPosition(const VoxelIndex &idx)
  {
    Position pos;
  ...
  template <typename VoxelType>
  bool MapBase<VoxelType>::isInMap(const VoxelIndex &idx)
  {
  ...
  template <typename VoxelType>
  bool MapBase<VoxelType>::isInBox(const Position &pos)
  {
    for (int i = 0; i < 3; ++i)
    {
  ...
  template <typename VoxelType>
  bool MapBase<VoxelType>::isInBox(const VoxelIndex &idx)
  {
    for (int i = 0; i < 3; ++i)
    {
  ...
  template <typename VoxelType>
  void MapBase<VoxelType>::boundIndex(VoxelIndex &idx)
  {
  ...
  template <typename VoxelType>
  VoxelType MapBase<VoxelType>::getVoxel(const Position &pos)
  {
    return getVoxel(positionToAddress(pos));
  }

  template <typename VoxelType>
  VoxelType MapBase<VoxelType>::getVoxel(const VoxelIndex &idx)
  {
    return getVoxel(indexToAddress(idx));
  }

  template <typename VoxelType>
  VoxelType MapBase<VoxelType>::getVoxel(const VoxelAddress &addr)
  {
  ...
  template <typename VoxelType>
  void MapBase<VoxelType>::getBoxBoundingBox(Position &min, Position &max)
  {
