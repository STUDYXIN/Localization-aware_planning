...
double CtrlFSM::get_yaw_from_odom() { return get_yaw_from_quaternion(odom_data.q); }
...
bool CtrlFSM::px4_init() { return (odom_data.odom_init && imu_data.imu_init && cmd_data.cmd_init); }
