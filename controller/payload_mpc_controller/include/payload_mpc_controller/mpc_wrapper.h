...
#include "acado_common.h"
    ...
    public:
        ...
        // bool setLimits(real_t max_accz, real_t max_rollpitchrate, real_t max_yawrate);
        bool setLimits(real_t max_accz, real_t max_rollpitchrate, real_t max_yawrate, real_t max_vel);
    ...
    private:
        ...
        // Eigen::Map<Eigen::Matrix<real_t, 3, kSamples>>
