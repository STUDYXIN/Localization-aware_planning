...
out[9] = ((((((xd[3]*xd[3])+(xd[6]*xd[6]))-(xd[4]*xd[4]))-(xd[5]*xd[5]))*u[0])-(real_t)(9.7949999999999999e+00));
}
...
out[129] = ((xd[3]+xd[3])*u[0]);
out[130] = (((real_t)(0.0000000000000000e+00)-(xd[4]+xd[4]))*u[0]);
out[131] = (((real_t)(0.0000000000000000e+00)-(xd[5]+xd[5]))*u[0]);
out[132] = ((xd[6]+xd[6])*u[0]);
out[133] = (real_t)(0.0000000000000000e+00);
out[134] = (real_t)(0.0000000000000000e+00);
out[135] = (real_t)(0.0000000000000000e+00);
out[136] = ((((xd[3]*xd[3])+(xd[6]*xd[6]))-(xd[4]*xd[4]))-(xd[5]*xd[5]));
