...
public:
  ...
  void searchPathOfYaw(
      const vector<Eigen::Vector3d>& pos, const vector<Eigen::Vector3d>& acc, const double& dt, vector<double>& path);
  ...
  double calcCoVisibility(const Eigen::Vector3d& pos1, const Eigen::Vector3d& pos2, const Eigen::Vector3d& acc1,
