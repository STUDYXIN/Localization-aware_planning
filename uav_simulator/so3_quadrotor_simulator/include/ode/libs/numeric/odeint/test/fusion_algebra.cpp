...
BOOST_AUTO_TEST_CASE(for_each5) {
  fusion_fixture f;
  algebra.for_each5(
      f.res, f.x, f.k1, f.k2, f.k3, default_operations::scale_sum4<value_type, time_type, time_type, time_type>(1.0, dt, dt, dt));
...
BOOST_AUTO_TEST_CASE(for_each15) {
  ...
  algebra.for_each15(f.res, f.x, f.k1, f.k2, f.k3, f.k4, f.k5, f.k6, f.k1, f.k2, f.k3, f.k4, f.k5, f.k6, f.k1,
      default_operations::scale_sum14<value_type, time_type, time_type, time_type, time_type, time_type, time_type, time_type,
