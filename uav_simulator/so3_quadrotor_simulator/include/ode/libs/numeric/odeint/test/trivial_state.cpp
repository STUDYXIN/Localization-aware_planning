...
typedef mpl::vector<
    euler<state_type, value_type, deriv_type, time_type, vector_space_algebra, default_operations, never_resizer>,
    runge_kutta4<state_type, value_type, deriv_type, time_type, vector_space_algebra, default_operations,
...
typedef mpl::vector<runge_kutta_cash_karp54<state_type, value_type, deriv_type, time_type, vector_space_algebra,
    ...
    runge_kutta_dopri5<state_type, value_type, deriv_type, time_type, vector_space_algebra, default_operations,
        never_resizer> >
    error_stepper_types;
